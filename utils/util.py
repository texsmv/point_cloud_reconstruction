...
def prepare_results_dir(output_dir, b_clean = True):
...
def load_latest_epoch(E, G, EG_optim, weights_path, starting_epoch):
    if starting_epoch > 1:
...
def save_weights(E, G, EG_optim, weights_path, epoch):
